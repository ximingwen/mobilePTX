...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', default='/shared_data/bamc_ph1_test_data', type=str)
    ...
    parser.add_argument('--sparse_checkpoint', default='sparse_coding_torch/output/48_ptx/best_sparse.pt/', type=str)
